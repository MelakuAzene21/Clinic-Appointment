...
const AdminDashboard = () => {
  const { user, doctors, fetchDoctors, registerDoctor } = useContext(AppContext);
  ...
  const stats = {
    ...
    totalPatients: 150, // Mock data
    totalAppointments: 89, // Mock data
    totalRevenue: 4500 // Mock data
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <p className="text-sm text-gray-600">New doctor registration: Dr. Sarah Patel</p>
                    <span className="text-xs text-gray-400">2 hours ago</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
                    <p className="text-sm text-gray-600">Appointment completed: John Doe with Dr. James</p>
        ...
        {activeTab === 'patients' && (
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Patients Management</h2>
